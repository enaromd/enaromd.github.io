...
<blockquote>
    <strong>Punto Clave:</strong> La salud metabólica no se puede inferir solo a partir de la masa corporal. En adultos con IMC normal clasificados en el fenotipo de Obesidad Periférica, <strong>cruzar el umbral elevado de METS-IR desencadena un incremento de 3.60 veces en el riesgo relativo de fibrosis hepática confirmada por FibroScan</strong>, lo que demuestra que la resistencia a la insulina subclínica impulsa el daño tisular mucho antes de que se manifieste la obesidad clínica evidente.
</blockquote>
